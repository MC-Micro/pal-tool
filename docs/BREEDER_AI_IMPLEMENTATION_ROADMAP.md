...
Die Breeder-AI-Runtime wird in einem eigenen App-/Package-Bereich isoliert. Vorgesehener Zielbereich ist `apps/breeder-ai/`; die interne Aufteilung wird in Phase 0 festgelegt. Die historische Passives PWA ist inzwischen unverändert als eingefrorene Legacy-App unter `apps/passives-pwa/` konserviert; sie bleibt außerhalb der Breeder-AI-Phasen.
